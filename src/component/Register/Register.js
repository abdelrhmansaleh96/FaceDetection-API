          ...
          <form className="measure center">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mv3">
                ...
                <div className="ma2">
                  <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Register" onClick={()=>onFormClick('home')}></input>
                </div>
              <div className="lh-copy mt3">
                <p
                 onClick={()=>onFormClick('signin')}
